...
class __TwigTemplate_464d0e870395c8116da99ac1de23f06d extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 18
        yield "\t\t<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.3/united/bootstrap.min.css\">
...
\t\t";
        // line 31
        yield from         $this->loadTemplate("admin/partials/_header.html.twig", "admin/base.html.twig", 31)->unwrap()->yield($context);
        // line 32
        yield "\t\t";
        yield from         $this->loadTemplate("admin/partials/_flash.html.twig", "admin/base.html.twig", 32)->unwrap()->yield($context);
        // line 33
        yield "\t\t";
        yield from $this->unwrap()->yieldBlock('body', $context, $blocks);
        // line 34
        yield "\t\t";
        yield from         $this->loadTemplate("admin/partials/_footer.html.twig", "admin/base.html.twig", 34)->unwrap()->yield($context);
        // line 35
        yield "\t</body>
</html>
";
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        yield "LumiDesign - Administration -
\t\t\t";
...
\t\t\t";
    ...
    {
        return array (  201 => 33,  187 => 26,  177 => 25,  166 => 28,  163 => 25,  135 => 24,  114 => 6,  101 => 35,  98 => 34,  95 => 33,  92 => 32,  90 => 31,  86 => 29,  79 => 24,  75 => 21,  71 => 18,  66 => 14,  61 => 10,  58 => 8,  56 => 6,  49 => 1,);
    }
...
\t\t<meta charset=\"UTF-8\">
\t\t<title>
\t\t\t{% block title %}LumiDesign - Administration -
\t\t\t{% endblock %}
\t\t</title>
\t\t{# Meta #}
\t\t<meta
...
\t\t{# Favicon #}
\t\t<link rel=\"icon\" href={{ asset('img/logo/lumi-design-logo.png') }}>{% block stylesheets %}{% endblock %} {% block javascripts %}
\t\t\t{% block importmap %}
\t\t\t\t{{ importmap('app') }}
\t\t\t{% endblock %}
\t\t{% endblock %}
...
", "admin/base.html.twig", "/Users/oura/Desktop/lumi_design/templates/admin/base.html.twig");
    }
}
