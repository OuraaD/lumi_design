...
class getDoctrine_Orm_DefaultListeners_AttachEntityListenersService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addEntityListener('App\\Entity\\Orders', 'App\\EntityListener\\OrderListener', 'prePersist', 'onPrePersist');
        $instance->addEntityListener('App\\Entity\\Product', 'App\\EntityListener\\ProductListener', 'prePersist');
        $instance->addEntityListener('App\\Entity\\Product', 'App\\EntityListener\\ProductListener', 'preUpdate');
